...
public:
    double findMedianSortedArrays(vector<int>& nums1, vector<int>& nums2) 
    {
        ...
        /*
        try to understand what lo and hi means before writing code
        here they mean NUMBER of elements chosen
        lo=0 means I choose 0 elements
        hi = n means I choose all elements
        based on this, I'm trying to figure out left half, right half.
        */
        int lo = 0, hi = n;
        /*
        ...
        I need to select [lo, mid-1] and [mid to hi]
        min mid can become is 0 and hence mid-1 can be -1, then I can assign INT_MIN to left array.
